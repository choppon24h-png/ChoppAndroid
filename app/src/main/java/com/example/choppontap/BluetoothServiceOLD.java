...
/**
 * @deprecated SERVIÇO LEGADO — NÃO USAR EM NOVAS FEATURES.
 *
 * Esta classe foi renomeada de BluetoothService para BluetoothServiceOLD
 * e mantida exclusivamente como backup/referência histórica.
 *
 * Use BluetoothServiceIndustrial para todas as integrações BLE.
 *
 * @see BluetoothServiceIndustrial
 */
 ...
 */
public class BluetoothServiceOLD extends Service {
    ...
    public class LocalBinder extends Binder {
        public BluetoothServiceOLD getService() { return BluetoothServiceOLD.this; }
    }
    ...
    public void onCreate() {
        ...
        mBleManager = new BleManager(new BleManager.Callback() {
                        ...
                        if (mBluetoothGatt != null
                            ...
                            if (!ok) {
                                ...
                                mBluetoothGatt = device.connectGatt(
                                        BluetoothServiceOLD.this, true, mGattCallback);
                            }
                        } else {
                            closeGatt();
            ...
            public void onCommandAck(BleCommand cmd) {
                ...
                LocalBroadcastManager.getInstance(BluetoothServiceOLD.this).sendBroadcast(ackIntent);
            }
            @Override
            public void onCommandDone(BleCommand cmd) {
                ...
                LocalBroadcastManager.getInstance(BluetoothServiceOLD.this).sendBroadcast(doneIntent);
            }
            @Override
            public void onCommandError(BleCommand cmd, String reason) {
                ...
                LocalBroadcastManager.getInstance(BluetoothServiceOLD.this).sendBroadcast(errIntent);
            }
            @Override
        ...
        mCommandQueue = new CommandQueueManager(
                ...
                new CommandQueueManager.Callback() {
                    ...
                    public void onAck(BleCommand cmd) {
                        ...
                        LocalBroadcastManager.getInstance(BluetoothServiceOLD.this).sendBroadcast(i);
                    }
                    @Override
